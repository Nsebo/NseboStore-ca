...
const Header = () => {
  ...
  const notify = () => toast('Kindly Add an Item to Cart!');
  // const notify = () => alert('Add an Item to Cart');
  ...
  return (
    <header className={styles.header_container}>
      ...
      <ToastContainer />
      <div className='' onClick={cartQuantity < 1 && notify}>
        <Link to={cartQuantity ? '/checkout' : null} className={styles.cart}>
          <svg
            width='24'
            height='20'
            viewBox='0 0 24 20'
